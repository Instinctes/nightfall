# NIGHTFALLCOIN 0.9.4 — mainnet wallets

Current release: [v0.9.4](https://github.com/Instinctes/nightfall/releases/tag/v0.9.4).
...
|---|---|---|
| Apple Silicon | `NIGHTFALLCOIN-Core-0.9.4-macOS-arm64.dmg` | macOS 11 |
| Intel Mac | `NIGHTFALLCOIN-Core-0.9.4-macOS-intel.dmg` | macOS 10.15 |
| Windows x64 | `nightfall-core-0.9.4-windows-x64.exe` | Windows 10 |
| Linux x64 | `nightfall-core-0.9.4-linux-x64` | GTK/X11 libraries required |
| Mobile/browser | [Web wallet](https://nightfallcoin.org/wallet/) | Modern browser |

Check the matching `SHA256SUMS-0.9.4.txt`, `SHA256SUMS-0.9.4-windows.txt`
or `SHA256SUMS-0.9.4-linux.txt` before running a download. macOS bundles are
