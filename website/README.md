<!-- This is the WEBSITE readme. It is not the project readme.
     Copying it to the repository root replaced the project's front
     page with Cloudflare Worker documentation, twice, unnoticed. -->
