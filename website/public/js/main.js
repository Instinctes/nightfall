    ...
    const platform = () => {
        ...
        if (/Win/i.test(plat) || /Windows/i.test(ua)) {
            return {
                ...
                href: "downloads/nightfall-core-0.9.4-windows-x64.exe",
                cta: "Download 0.9.4",
            };
        }
        if (/Mac/i.test(plat) || /Mac OS X/i.test(ua)) {
            ...
            return arm
                ? {
                      ...
                      req: "M1 – M4 · macOS 11+",
                      href: "downloads/NIGHTFALLCOIN-Core-0.9.4-macOS-arm64.dmg",
                      cta: "Download 0.9.4",
                  }
                : {
                      key: "mac-intel",
                      ...
                      href: "downloads/NIGHTFALLCOIN-Core-0.9.4-macOS-intel.dmg",
                      cta: "Download 0.9.4",
                  };
        }
        if (/Linux/i.test(plat) || /Linux/i.test(ua)) {
            return {
                ...
                href: "downloads/nightfalld-0.9.4-linux-x64",
