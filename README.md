...
> [!IMPORTANT]
> **Running 0.5.4 or earlier? Update.** From v0.6.0 the network speaks wire
...
> [v0.6.0](https://github.com/Instinctes/nightfall/releases/tag/v0.6.0).
...
```bash
shasum -a 256 -c SHA256SUMS-0.6.0.txt
```
</details>
...
```powershell
certutil -hashfile nightfall-core-0.6.0-windows-x64.exe SHA256
```
</details>
