...
**Current mainnet wallet release: [1.0.4](https://github.com/Instinctes/nightfall/releases/tag/v1.0.4).**
...
```bash
shasum -a 256 -c SHA256SUMS-1.0.4.txt
```
</details>
...
```powershell
certutil -hashfile nightfall-core-1.0.4-windows-x64.exe SHA256
```
</details>
