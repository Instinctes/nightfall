...
**Current mainnet wallet release: [1.0.1](https://github.com/Instinctes/nightfall/releases/tag/v1.0.1).**
...
```powershell
certutil -hashfile nightfall-core-1.0.1-windows-x64.exe SHA256
```
</details>
...
1.0.1**. It is not in the wallet and is not scheduled for a later release.
...
| [docs/SWAP-WITHDRAWN.md](docs/SWAP-WITHDRAWN.md) | Why atomic swap was withdrawn before 1.0.1 |
