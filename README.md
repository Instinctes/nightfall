...
**Current mainnet wallet release: [0.9.5](https://github.com/Instinctes/nightfall/releases/tag/v0.9.5).**
...
is not a mainnet safety certification. See the [release notes](RELEASE-NOTES/RELEASE-NOTES-v0.9.5.md).
...
```bash
shasum -a 256 -c SHA256SUMS-0.9.5.txt
```
</details>
...
```powershell
certutil -hashfile nightfall-core-0.9.5-windows-x64.exe SHA256
```
</details>
