...
**Current mainnet wallet release: [0.9.4](https://github.com/Instinctes/nightfall/releases/tag/v0.9.4).**
...
**Atomic swaps remain disabled on mainnet**; experimental devnet/testnet work
is not a mainnet safety certification. See the [release notes](RELEASE-NOTES/RELEASE-NOTES-v0.9.4.md).
...
```bash
shasum -a 256 -c SHA256SUMS-0.9.4.txt
```
</details>
...
```powershell
certutil -hashfile nightfall-core-0.9.4-windows-x64.exe SHA256
```
</details>
