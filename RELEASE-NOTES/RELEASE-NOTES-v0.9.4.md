...
- `NIGHTFALLCOIN-Core-0.9.4-macOS-arm64.dmg` — macOS 11+
- `NIGHTFALLCOIN-Core-0.9.4-macOS-intel.dmg` — macOS 10.15+
- `nightfall-core-0.9.4-windows-x64.exe`
- `nightfall-core-0.9.4-linux-x64` — GUI dependencies required
- `nightfalld` and `nightfall-wallet` CLI binaries for Windows/Linux;
  macOS includes them inside the app bundle.

Verify against `SHA256SUMS-0.9.4.txt`, `SHA256SUMS-0.9.4-windows.txt` or
`SHA256SUMS-0.9.4-linux.txt` before running downloads. macOS apps are ad-hoc
